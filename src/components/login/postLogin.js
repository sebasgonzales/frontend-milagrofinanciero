...
const PostLogin = () => {
  ...
  const iniciarSesion = async () => {
    try {
      const response = await axios.post(`https://colosal.duckdns.org:15001/MilagroFinanciero/Login/authenticate/${valorQueryParam}`, { username: data.username, password: sha256(data.password)});
